...
export const mockComponents: Component[] = [
  // CPUs
  { id: "cpu-1", category: "CPU", name: "AMD Ryzen 7 7800X3D", brand: "AMD", price: 349.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1591405351990-4726e331f141?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 120, specs: { Cores: "8", Threads: "16", BaseClock: "4.2GHz", Socket: "AM5" } },
  ...
  { id: "cpu-3", category: "CPU", name: "AMD Ryzen 5 7600", brand: "AMD", price: 199.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1591405351990-4726e331f141?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 65, specs: { Cores: "6", Threads: "12", BaseClock: "3.8GHz", Socket: "AM5" } },
  ...
  // GPUs
  { id: "gpu-1", category: "Video Card", name: "NVIDIA GeForce RTX 4090", brand: "NVIDIA", price: 1599.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1591488320449-011701bb6704?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 450, specs: { VRAM: "24GB GDDR6X", CoreClock: "2.23GHz" } },
  ...
  { id: "gpu-3", category: "Video Card", name: "ASUS TUF Gaming RTX 4070 Ti", brand: "ASUS", price: 799.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1591488320449-011701bb6704?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 285, specs: { VRAM: "12GB GDDR6X", CoreClock: "2.61GHz" } },
  ...
  { id: "mobo-2", category: "Motherboard", name: "MSI MAG Z790 TOMAHAWK WIFI", brand: "MSI", price: 289.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 35, specs: { Socket: "LGA1700", FormFactor: "ATX" } },
  ...
  // Memory
  { id: "ram-1", category: "Memory", name: "Corsair Vengeance 32GB (2x16GB) DDR5", brand: "Corsair", price: 114.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1563770660941-20978e870e26?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 10, specs: { Speed: "6000MHz", Modules: "2x16GB", Type: "DDR5" } },
  ...
  // Storage
  { id: "stor-1", category: "Storage", name: "Samsung 990 PRO 2TB NVMe SSD", brand: "Samsung", price: 189.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1597848212624-a1fb16eadef0?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 8, specs: { Capacity: "2TB", Interface: "PCIe 4.0 x4" } },
  ...
  // Case
  { id: "case-1", category: "Case", name: "NZXT H9 Flow", brand: "NZXT", price: 159.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1587202372634-32705e3bf49c?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 15, specs: { FormFactor: "ATX Mid Tower", SidePanel: "Tempered Glass" } },
  ...
  // Power Supply
  { id: "psu-1", category: "Power Supply", name: "Corsair RM850x (2021) 850W", brand: "Corsair", price: 139.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1587202372634-32705e3bf49c?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 0, specs: { Wattage: "850W", Efficiency: "80+ Gold", Modular: "Full" } },
  ...
  // CPU Cooler
  { id: "cool-1", category: "CPU Cooler", name: "NZXT Kraken Elite 360", brand: "NZXT", price: 279.99, provider: "PrimeABGB", image: "https://images.unsplash.com/photo-1587202372634-32705e3bf49c?q=80&w=400&auto=format&fit=crop", inStock: true, wattage: 15, specs: { Type: "Liquid", RadiatorSize: "360mm" } },
